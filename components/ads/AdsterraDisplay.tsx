...
export function AdsterraDisplay() {
  ...
  useEffect(() => {
    ...
    opt.textContent = `atOptions = { 'key': 'c47ab9f4e47d82e5f203c0a544bfbef0', 'format': 'iframe', 'height': 90, 'width': 728, 'params': {} };`;
    ref.current.appendChild(opt);
    const invoke = document.createElement('script');
    invoke.src = 'https://www.highperformanceformat.com/c47ab9f4e47d82e5f203c0a544bfbef0/invoke.js';
